      ...
      <nav class="navbar navbar-expand-lg main-navbar">
        ...
        <div class="nav-collapse">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item"><a href="<?= base_url(); ?>User/request" class="nav-link">Request</a></li>
            <li class="nav-item"><a href="<?= base_url(); ?>User/ephone" class="nav-link">E-Phone</a></li>
            <li class="nav-item"><a href="<?= base_url(); ?>User/about" class="nav-link">About Us</a></li>
          </ul>
        </div>
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li>
            <a href="<?= base_url(); ?>User/Login" class="btn btn-success">Sign In</a>
          </li>
        </ul>
      </nav>