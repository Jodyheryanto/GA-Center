...
<head>
  ...
  <title>PT. KARYA TECHNIK MULTIFINANCE</title>
  <link rel="shortcut icon" type="image/png" href="<?= base_url() ?>/assets/img/logo.jpeg" />
...
<body class="layout-2">
  <div id="app">
    <div class="main-wrapper">
      <div class="navbar-bg" style="background-color: #1A1349"></div>
      <nav class="navbar navbar-expand-lg main-navbar">
        <a href="<?= base_url(); ?>"><img src="<?= base_url() ?>/assets/img/logo.jpeg" width="90" style="margin-left: -10px" alt="Logo"></a>
        <a style="padding-left: 10px;" href="<?= base_url(); ?>" class="navbar-brand sidebar-gone-hide">GA Center</a>
        ...
        <div class="nav-collapse">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item"><a href="<?= base_url(); ?>Admin/request" class="nav-link">Request</a></li>
            <li class="nav-item"><a href="<?= base_url(); ?>Admin/ephone" class="nav-link">E-Phone</a></li>
            <li class="nav-item"><a href="<?= base_url(); ?>Admin/about" class="nav-link">About Us</a></li>
          </ul>
        </div>
        ...
        <ul class="navbar-nav navbar-right">
          ...
          <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
            ...
            <div class="dropdown-menu dropdown-menu-right">
              ...
              <a href="<?= base_url() ?>User" class="dropdown-item has-icon text-danger">
