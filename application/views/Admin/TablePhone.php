        ...
        <div class="section-body">
            <div class="card">
                ...
                <div class="card-header-form">
                    <a href="<?= base_url() ?>User/InsertPhone" class="btn btn-primary" style="padding: 5px; margin-right: 25px"><i class="fas fa-edit"></i> Create</a>
                </div>
                <div class="card-header-form">
                    <form>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped">
                            ...
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="<?= base_url(); ?>User/ChangePhone/<?= $value['ID']; ?>" class="btn btn-primary">Edit</a>
                                    <a href="<?= base_url(); ?>User/DelDbPhone/<?= $value['ID']; ?>" class="btn btn-danger">Hapus</a>
                                </td>
                            </tr>
                            <?php $i++ ?>
                            <?php endforeach; ?>
